...
public class Sam2 extends AbstractSamJ {
	...
	protected void processPromptsBatchWithSAM(SharedMemoryArray shmArr, boolean returnAll) {
		String code = ""
				+ "num_threads = 5" + System.lineSeparator()
				+ "from concurrent.futures import ThreadPoolExecutor, as_completed" + System.lineSeparator()
				+ "def respond_in_thread(task, args):" + System.lineSeparator()
		...
		code += ""
				...
				+ "    future = executor.submit(respond_in_thread, task, args)" + System.lineSeparator()
				...
				+ "  for i, future in enumerate(futures):" + System.lineSeparator()
