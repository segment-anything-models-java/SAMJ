...
public class JSwitchButton extends AbstractButton{
        private Color colorBright = new Color(240,240,240);
        ...
        public JSwitchButton(String trueLabel, String falseLabel) {
            ...
            double trueLenth   = 5+getFontMetrics( getFont() ).getStringBounds( trueLabel, getGraphics() ).getWidth();
            double falseLenght = 5+getFontMetrics( getFont() ).getStringBounds( falseLabel, getGraphics() ).getWidth();
        ...
        protected void paintComponent( Graphics g ) {
            ...
            if (w>14){
                ...
                g2.fillRect(x+w/2-size/2-9,y+h/2-size/2-2, size+18, size);
            ...
            g2.drawString( getText(), lx+gap, y+h/2+h/4-2 );
        }
    }